...
public class Assignment77 {
	...
	static void createTask()
	{
		try
		{
			oPage.taskCrete1().click();
			Thread.sleep(2000);
			oPage.taskCrete2().click();
			Thread.sleep(4000);
			oPage.taskCrete3().click();
			Thread.sleep(2000);
			oPage.taskCrete3().sendKeys("Task1");
			oPage.taskCrete4().click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();		
	...
	static void deleteTask()
	{
		try
		{
			oPage.deltask1().click();
			Thread.sleep(2000);
			 oPage.deltask2().click();
			 Thread.sleep(2000);
			 oPage.deltask3().click();
			 Thread.sleep(2000);
			 oPage.deltask4().click();
			 Thread.sleep(2000);
