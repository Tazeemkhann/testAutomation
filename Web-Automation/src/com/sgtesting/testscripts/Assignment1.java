...
public class Assignment1 {
	...
	static void createUser()
	{
		...
		oBrowser.findElement(By.id("userDataLightBox_emailField")).sendKeys("zaidahmed@gmail.com");
		oBrowser.findElement(By.id("userDataLightBox_passwordField")).sendKeys("Qwerty123");
